...
public class Filter {
    ...
    /*
        ...
        filterOutput[4] -= -3.507786207390782*filterOutput[3] + 4.640902412686707*filterOutput[2] -
                ...
                */
        //Constants for wn = 0.1
        filterOutput[4] = 0.416599204406599*filterInput[4] + 1.66639681762640*filterInput[3] +
                2.49959522643960*filterInput[2] + 1.66639681762640*filterInput[1] +
                0.416599204406599*filterInput[0];
        filterOutput[4] *= 0.001;
        filterOutput[4] -= -3.180638548874719*filterOutput[3] + 3.861194348994213*filterOutput[2] -
                -2.112155355110969*filterOutput[1] + 0.438265142261980*filterOutput[0];
